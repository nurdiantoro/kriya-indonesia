...
<form method="POST" action="{{ url('dashboard/profile/update_password') }}">
    @csrf
    <div class="md:w-1/2 pb-20">
        <div class="border-[1px] rounded-md shadow-md px-2 py-2 bg-white overflow-hidden mb-2">
            <span class="text-xl font-bold text-gray-800">Change Password</span>
            <table class="w-full">
                <tr>
                    <td class="w-20 md:w-60">New Password</td>
                    <td>:</td>
                    <td>
                ...
                <tr>
                    <td class="w-20 md:w-60">Confirm Password</td>
                    <td>:</td>
                    <td>
                        <input
                            class="w-full border rounded-md p-2 bg-gray-100 focus:bg-white focus:outline-warna-01 focus:outline-1"
