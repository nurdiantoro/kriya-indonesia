...
<div class="flex flex-row gap-2 justify-between md:w-1/2">
    <div class="mb-2">
        <a href="{{ url('dashboard/exhibitor_form_a/' . $exhibitor->id) }}" class="btn btn-outline-primary">Back</a>
    </div>
</div>

<form method="POST" action="{{ url('dashboard/exhibitor_form_a/update') }}">
    @csrf
            ...
            <table class="w-full">
                ...
                <tr>
                    ...
                    <td>
                        <input
                            class="w-full border rounded-md p-2 bg-gray-100 focus:bg-white focus:outline-warna-01 focus:outline-1"
                            type="text" name="provinsi" id="provinsi" value="{{ $exhibitor->provinsi }}">
                    </td>
                </tr>
                <tr>
                    <td>Email</td>
            ...
            <table class="w-full">
                ...
                <tr>
                    ...
                    <td>
                        <input
                            class="w-full border rounded-md p-2 bg-gray-100 focus:bg-white focus:outline-warna-01 focus:outline-1"
                            type="text" name="sales" id="sales" value="{{ $exhibitor->sales }}">
                    </td>
                </tr>
                {{-- <tr>
