...
<div class="md:w-1/2 pb-20">
    <div class="border-[1px] rounded-md shadow-md px-2 py-2 bg-white overflow-hidden mb-2">
        ...
        <table class="w-full">
            <tr>
                ...
                <td>:</td>
                <td>
                    <input disabled class="w-full border border-white bg-white rounded-md p-2" type="text" name="name"
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <input disabled class="w-full border border-white bg-white rounded-md p-2" type="email" name="email"
            ...
            <tr>
                ...
                <td>
                    <input disabled class="w-full border border-white bg-white rounded-md p-2" type="text"
                        name="no_telp" id="no_telp" value="{{ $user->no_telp }}">
                </td>
            </tr>
            <tr>
                <td>qr_code</td>
    ...
    <div class="flex flex-row gap-4 justify-end w-full">
        <a href="{{ url('dashboard/profile/change') }}">
            <button class="btn btn-sm btn-outline-primary">Ubah Profile</button>
        </a>
        <a href="{{ url('dashboard/profile/change_password') }}">
            <button class="btn btn-sm btn-outline-danger">Ubah Password</button>
        </a>
    </div>
</div>
