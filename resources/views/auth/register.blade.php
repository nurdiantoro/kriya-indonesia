...
<div class="min-h-screen w-screen bg-cover flex flex-col  items-center px-4"
    ...
    <form action="{{ url('register') }}" method="POST" class="rounded md:w-1/3 bg-white shadow-md p-4 mt-10">
        @csrf
        <h1 class="text-3xl font-bold text-center text-warna-01 mb-4">REGISTRATION</h1>
        <div>
