<nav class="bg-warna-01 md:px-40 drop-shadow-lg flex justify-between items-center fixed w-screen z-50 h-12">
    <div class="flex flex-row justify-between items-center px-4 w-full h-full z-20">
        ...
        <button type="button" onclick="toogleNavbar()">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="h-6 inline text-white md:hidden"
                id="bar">
    ...
    <div id="navbar-link"
        class="-translate-y-full opacity-100 duration-1000 md:translate-y-0 z-10 flex flex-col absolute top-10 left-0 md:static md:flex-row gap-2 md:gap-4 md:bg-transparent bg-warna-01 w-screen md:w-auto items-center">
        <a href="{{ url('') }}"
