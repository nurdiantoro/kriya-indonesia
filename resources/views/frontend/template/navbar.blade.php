<nav class="bg-warna-01 md:px-40 drop-shadow-lg flex justify-between items-center fixed w-screen z-50 h-12">
    ...
    <div class="hidden md:block" id="navbar-link">
        <div
            class="duration-1000 md:translate-y-0 z-10 flex flex-col absolute top-10 left-0 md:static md:flex-row gap-2 md:gap-4 md:bg-transparent whitespace-nowrap bg-warna-01 w-screen md:w-auto items-center">
            <a href="{{ url('') }}"
